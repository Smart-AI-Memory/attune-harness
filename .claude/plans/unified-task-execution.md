...
Spec: `docs/specs/unified-task-execution/`. Tasks 1–7 accepted on offline evidence; 7/8 accepted. Task 8 protocol is frozen and offline-tested; native comparative qualification is pending.
