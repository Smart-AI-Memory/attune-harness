...
b89f7953f: the five tests for these names, unchanged but for the import. The
six for the form template and the command-line seam stayed behind with them.
New: the Harness-shaped tree, a mixed tree, the cap, and a root with no src.
"""
